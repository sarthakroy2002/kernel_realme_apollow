...
{OV64B_SENSOR_ID, SENSOR_DRVNAME_OV64B_MIPI_RAW, OV64B_MIPI_RAW_SensorInit},
#endif
#if defined(IMX471_MIPI_RAW2)
{IMX471_SENSOR_ID2, SENSOR_DRVNAME_IMX471_MIPI_RAW2, IMX471_MIPI_RAW2_SensorInit},
#endif
#if defined(OV8856_MIPI_RAW2)
{OV8856_SENSOR_ID2, SENSOR_DRVNAME_OV8856_MIPI_RAW2, OV8856_MIPI_RAW2_SensorInit},
#endif
#if defined(GC02M1B_MIPI_MONO)
{GC02M1B_SENSOR_ID, SENSOR_DRVNAME_GC02M1B_MIPI_MONO, GC02M1B_MIPI_MONO_SensorInit},
#endif
...
#if defined(IMX471_MIPI_RAW2)
	{
		SENSOR_DRVNAME_IMX471_MIPI_RAW2,
		{
			{RST, Vol_Low, 1},
			{AVDD, Vol_2800, 0},
			{DVDD, Vol_1100, 0},
...
#if defined(OV8856_MIPI_RAW2)
	{
		SENSOR_DRVNAME_OV8856_MIPI_RAW2,
		{
			{SensorMCLK, Vol_High, 0},
			{RST, Vol_Low, 1},
			{AVDD, Vol_2800, 0},
